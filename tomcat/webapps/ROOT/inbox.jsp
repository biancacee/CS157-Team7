...
<div class="container">
    <%
        try
        {
            ...
            PreparedStatement stmt = con.prepareStatement("SELECT message_id, sender_id, receiver_id, message, time_stamp FROM private_message WHERE receiver_id = ? ORDER BY time_stamp DESC LIMIT ?, ?");
